...
vector<int> piece_count_search(temp_Board & current_board, int depth);
vector<double> min_max_search(NeuralNetwork_PERF & nnp, temp_Board & current_board, int depth); //ist entry is move, 2nd is value
